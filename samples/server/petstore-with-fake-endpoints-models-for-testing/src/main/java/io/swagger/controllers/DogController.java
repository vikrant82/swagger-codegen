...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaInflectorServerCodegen", date = "2020-02-29T02:28:40.316-05:00[America/Bogota]")public class DogController  {
  /** 
...
, String apiKey 
  ...
  */
  ...
  /*
    public ResponseContext updateDogWithForm(RequestContext request , Long animalId 
,  String name
,  String status
) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
